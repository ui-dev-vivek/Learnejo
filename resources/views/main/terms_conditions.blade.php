@php
$title = 'Learnejo:Terms And Condition';
...
<x-layout.main.base :title="$title" :image="$image" :description="$description">
    ...
    <section id="about" class="about">
        <div class="container" data-aos="fade-up">
            ...
            <p>These terms and conditions outline the rules and regulations for the use of Learnejo's Website, located
                at https://learnejo.tech.</p>

            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                learnejo if you do not agree to take all of the terms and conditions stated on this page.</p>
            ...
            <p>We employ the use of cookies. By accessing learnejo, you agreed to use cookies in agreement with the
                Learnejo's Privacy Policy. </p>
            ...
            <p>Unless otherwise stated, Learnejo and/or its licensors own the intellectual property rights for all
                material on learnejo. All intellectual property rights are reserved. You may access this from learnejo
                for your own personal use subjected to restrictions set in these terms and conditions.</p>

            <p>You must not:</p>
            <ul>
                <li>Republish material from learnejo</li>
                <li>Sell, rent or sub-license material from learnejo</li>
                <li>Reproduce, duplicate or copy material from learnejo</li>
                <li>Redistribute content from learnejo</li>
            </ul>
            ...
            <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                certain areas of the website. Learnejo does not filter, edit, publish or review Comments prior to their
                presence on the website. Comments do not reflect the views and opinions of Learnejo,its agents and/or
                affiliates. Comments reflect the views and opinions of the person who post their views and opinions. To
                the extent permitted by applicable laws, Learnejo shall not be liable for the Comments or for any
            ...
            <p>Learnejo reserves the right to monitor all Comments and to remove any Comments which can be considered
            ...
            <p>You hereby grant Learnejo a non-exclusive license to use, reproduce, edit and authorize others to use,
            ...
            <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                ...
                absence of Learnejo; and (d) the link is in the context of general resource information.</p>
            ...
            <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                website, you must inform us by sending an e-mail to Learnejo. Please include your name, your
            ...
            <p>No use of Learnejo's logo or other artwork will be allowed for linking absent a trademark license
                agreement.</p>
