...
<x-layout.main.base :title="$title" :image="$image" :description="$description">
    <style>
        ...
        divx .total_que span p {
            font-weight: 500;
            padding: 0 5px;
        }

        divx .total_que span p:first-child {
            padding-left: 0px;
        }
    ...
    <!-- start Quiz button -->
    {{-- <div class="start_btn aqua-gradient"><button>Start Quiz</button></div> --}}
    <div class="container">
        <!-- Info Box -->
        <div class="info_box activeInfo container">
            <div class="info-title"><span>Some Rules of this Quiz</span></div>
            <div class="info-list">
                <div class="info">1. You will have only <span>12 seconds</span> per each question.</div>
    ...
    <script>
        ...
        const next_btn = document.querySelector("divx .next_btn");
        const bottom_ques_counter = document.querySelector("divx .total_que");
        ...
        function showQuetions(index) {
            ...
            let que_tag = '<span class="h5">' + questions[index].numb + ". " + questions[index].question + '</span>';
        ...
        function showResult() {
            ...
            if (userScore == 15) { // if user scored more than 3
                ...
                let scoreTag = '<span>and congrats! 🎉, You got <p>' + userScore + '</p> out of <p>' + questions.length +
                    '</p></span>';
                scoreText.innerHTML = scoreTag; //adding new span tag inside score_Text
            } else if (userScore >= 9) { // if user scored more than 1
                let scoreTag = '<span>and nice 😎, You got <p>' + userScore + '</p> out of <p>' + questions.length +
                    '</p></span>';
                scoreText.innerHTML = scoreTag;
            } else if (userScore == 0) { // if user scored more than 1
                let scoreTag = '<span>and Sorry 😐, You are Fail!. <p>' + userScore + '</p> out of <p>' + questions.length +
                    '</p></span>';
                scoreText.innerHTML = scoreTag;
            } else { // if user scored less than 1
                let scoreTag = '<span>and 😐, You got only <p>' + userScore + '</p> out of <p>' + questions.length +
                    '</p></span>';
                scoreText.innerHTML = scoreTag;
            }
        }
