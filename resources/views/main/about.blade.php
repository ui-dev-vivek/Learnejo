...
<x-layout.main.base :title="$title" :image="$image" :description="$description">
    ...
    <small>https://learnejo.com/</small>
    <p style=" text-align: justify;">'Learnejo' is an <b>E-learning platform</b>, for every student interested and wishes
        to prepare for <b>Technical</b> and <b>NON-Technical</b>. This platform contains all the important topics and
        articles related to<b>Technical</b> and <b>NON-Technical</b>. With the help of which you can enhance your skills
        and knowledge as well as enhance your career.</p>
    <p style=" text-align: justify;">learnejo : generally means <b>'Pathashala'</b>. In ancient times, education was
        taken through Gurukul. <br> Where not only intellectual but also social and classical knowledge was acquired in
        a pure environment. After that, the motivation to acquire knowledge started increasing, so Pathashala started
        being established at different places.<br> Today is the age of the Internet, the technical development is at a
        proper level. So ours and your <b>Pathshala (Learnejo) </b> also on the internet now. Just as a student won the
        battle by becoming a warrior after taking complete education in ancient times, in the same way you will also win
        the <b> Battle of your Career successfully</b>.</p>
