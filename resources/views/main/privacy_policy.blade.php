...
<x-layout.main.base :title="$title" :image="$image" :description="$description">
    ...
    <section id="about" class="about">
        <div class="container text-justify" data-aos="fade-up">
            ...
            <div class="row">
                <div class="col-sm-3" data-aos="fade-left" data-aos-delay="100">
                    <img style="border-radius:10px;"
                        src="https://images.pexels.com/photos/3760067/pexels-photo-3760067.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
                        class="img-fluid" alt="">
                </div>
                <div class="col-sm-9 text-justify"><br>
                    <p>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Website</strong> refers to OfForBy Students, accessible from <a
                            href="https://learnejo.tech" rel="external nofollow noopener"
                            target="_blank">https://learnejo.tech</a></p>
                </li>
                <li>
            ...
            <div class="row">
                ...
                <div class="col-sm-3" data-aos="fade-left" data-aos-delay="100">
                    <img style="border-radius:10px;"
                        src="https://images.pexels.com/photos/4152513/pexels-photo-4152513.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500"
                        class="img-fluid" alt="">
                </div>
            </div><br>
            ...
            <p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain on Your
                ...
                close Your web browser. You can learn more about cookies here: <a
                    href="https://www.termsfeed.com/blog/cookies/" target="_blank">All About Cookies by TermsFeed</a>.
            </p>
